...
Ol_Profiles = pd.read_excel(excel_path, sheet_name='Olivine Profiles_WDS+EDS', header=52, index_col='DataSet/Point')
# %%
...
step_x, step_c = step_condition(((0,inflect_x),(inflect_x,max_length)), (0.849,0.882), dx_micron)
...
step_x, step_c = step_condition(((0,inflect_x),(inflect_x,max_length)), (0.852,0.895), dx_micron)
bounds_c = (step_c[0],step_c[-1])
vector_c_in = step_c
vector_Fo_in = vector_c_in
